...
# MAGIC %md       
# MAGIC #### Create an ETL pipeline via `Jobs & Pipelines`
# MAGIC
# MAGIC - Access via workspace LHS Tab
# MAGIC - **Use this notebook as the `source` of the ETL pipeline**
# MAGIC
# MAGIC ![](../assets/imgs/proteindata_ETL_with_SDP_combi.png)
# MAGIC
...
# MAGIC <!-- <br>  -->
# MAGIC
# MAGIC #### When defined and run, the resulting pipeline would include 3 notebook tasks as observed above
# MAGIC

...
[`Flow of processes involved to setup the AIBI Genie Space within the` [`Databricks Intelligent Platform`](https://www.databricks.com/resources/demos/tours/horizontal/introducing-databricks-intelligence-platform) `and the features utilized (in red)`]

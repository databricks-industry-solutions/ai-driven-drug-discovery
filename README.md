...
|---------|---------|-----------|
| [biopython](https://github.com/biopython/biopython) | [Biopython License Agreement (dual licensed with BSD 3-Clause)](https://github.com/biopython/biopython/blob/master/LICENSE.rst) | Copyright (c) 1999-present, The Biopython Contributors |
